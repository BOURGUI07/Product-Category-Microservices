...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResourceError> handleResourceNotFoundException(CategoryNotFoundException ex) {
    ...
    public ResponseEntity<ResourceError> handleAlreadyExistsException(CategoryNameAlreadyExistsException ex) {
