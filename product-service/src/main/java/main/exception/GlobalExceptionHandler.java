...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResourceError> handleResourceNotFoundException(ProductNotFoundException ex) {
    ...
    public ResponseEntity<ResourceError> handleAlreadyExistsException(ProductNameAlreadyExistsException ex) {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<ResourceError> handleCustomException(CustomServerException ex) {
        var errorResponse = new ResourceError(HttpStatus.INTERNAL_SERVER_ERROR.value(), "An unexpected error occurred", System.currentTimeMillis());
        return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
    }
